...
for key in "${!SHORT[@]}"
  do
    ...
    #Us english accent
    mpg123 -q -w welcome_schenks_house.wav "http://translate.google.com/translate_tts?ie=UTF-8&client=tw-ob&q=$NEXTURL&tl=En-us" 
    #Italian accent
    #mpg123 -q -w wlecomd_casa_IT.wav "http://translate.google.com/translate_tts?ie=UTF-8&client=tw-ob&q=$NEXTURL&tl=it" 
